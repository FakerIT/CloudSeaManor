...
// Design refs:
// - docs/ENGINEERING_STANDARDS.md (存档兼容与迁移)
// - docs/TASKS.md (P10-GOV-005)
...
bool SaveGameState(const std::filesystem::path& save_path,
                   ...
                   const std::unordered_map<std::string, CloudSeamanor::domain::NPCDynamicDevelopment>*
                       npc_developments = nullptr);
...
bool LoadGameState(const std::filesystem::path& save_path,
                   ...
                   std::unordered_map<std::string, CloudSeamanor::domain::NPCDynamicDevelopment>*
                       npc_developments = nullptr);
