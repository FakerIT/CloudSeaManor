...
namespace Achievement {
    // 金币奖励
    constexpr int FirstCropReward = 100;
    constexpr int TenCropsReward = 500;
    constexpr int HomeDesignerReward = 200;
    constexpr int BeastBondMaxReward = 300;
    constexpr int FestCalendarReward = 150;

    // 物品奖励数量
    constexpr int GiftExpertTeaPackCount = 1;
    constexpr int MasterBuilderWoodCount = 5;
    constexpr int BeastBondFeedCount = 1;
    constexpr int SmallTycoonTeaPackCount = 2;

    // 提示持续时间
    constexpr float RewardHintDuration = 1.8f;
    constexpr float SpecialRewardHintDuration = 2.2f;
}
