...
// 架构豁免声明（P18-QUAL-006）
// ============================================================================
// 此文件依赖 engine/UiLayoutSystem.hpp，这是经过审查的特例：
// - UiLayoutSystem.hpp 只包含纯配置数据结构和类型定义（UiPageConfig 等）
// - AssetBridge 使用它是为了生成 UI 配置模板，需要了解配置结构
// - 不涉及任何运行时渲染逻辑或状态管理
// - 如需重构，可在 infrastructure 层定义精简版的配置结构副本
// ============================================================================
