...
// 【常量定义】背包系统配置
// ============================================================================
constexpr std::size_t kInventoryMaxSlots = 40;      // 最大槽位数
constexpr int kInventoryMaxStackSize = 999;       // 单槽最大叠加数量
constexpr int kInventoryDefaultCapacity = 40;      // 默认容量
...
public:
    ...
    // ========================================================================
    // 【槽位容量】背包最大槽位数（不同物品种类数上限）
    // ========================================================================
    [[nodiscard]] std::size_t MaxSlots() const noexcept { return kInventoryMaxSlots; }

    // ========================================================================
    // 【槽位检查】背包是否已满
    // ========================================================================
    [[nodiscard]] bool IsFull() const noexcept { return slots_.size() >= kInventoryMaxSlots; }

    // ========================================================================
    // 【叠加上限】获取单槽最大叠加数量
    // ========================================================================
    [[nodiscard]] static constexpr int MaxStackSize() noexcept { return kInventoryMaxStackSize; }

    // ========================================================================
    // 【剩余槽位】获取剩余可用槽位数
    // ========================================================================
    [[nodiscard]] std::size_t RemainingSlots() const noexcept {
        return kInventoryMaxSlots > slots_.size() ? kInventoryMaxSlots - slots_.size() : 0;
    }
