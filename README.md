...
- 灵兽跟随系统 ✅
- 节日系统 ✅
- 告白/婚礼系统 ✅（好感度10心可告白，订婚后可预约婚礼，婚后每日体力恢复增益）
- 邮件系统 ✅（包含每日茶推荐、每周礼物、促销活动等）
- 多槽位存档系统 ✅（3个存档槽位，支持缩略图和元数据）
- 战斗系统 ✅（已接入主循环，Victory自动结算，种子掉落）

### 待完善功能 🔧

- 音效系统 🔧 路由完整，待音频文件
- 像素 UI 🔧 面板框架完整，待美术资源（PNG精灵图）
- 存档系统增强 🔧 天气系统、任务运行时状态待接入存档

### 预留功能 📋

- MOD Hooks 扩展接口（预留，未激活）
- 梦境系统（预留，未实现）
